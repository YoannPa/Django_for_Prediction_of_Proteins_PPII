...
class Pdb(models.Model):
    ...
    nom_proteine = models.CharField(db_column='nom_Proteine', max_length=255)  # Field name made lowercase.
...
class MethodesRes(models.Model):
    meth_res = models.CharField(db_column='meth_Res', primary_key=True, max_length=10)  # Field name made lowercase.
